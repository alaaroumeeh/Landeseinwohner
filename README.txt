Project Name: Landeseinwohner
Objective: Simple commands interface to manipulate Excel sheet of world countries and their corresponding nationality and residents name in German language.
...
2) add:
	adds a new row to the table in alphabatical order for country names.
